...
jQuery(function(){
    ...
    var uploader = WebUploader.create({
        ...
        accept:{
            title: 'Images',
            extensions: 'gif,jpg,jpeg,png,zip,pdf,xlsx,xls,doc,ppt,rar',
            mimeTypes: '*'
        },
        resize: false,
    ...
    uploader.on('uploadError', function(filea,b){
    ...
    uploader.on('uploadBeforeSend', function(block, data){
        ...
        var obj = { "F_APP_ID": "", "F_ACCESS_TOKEN": "","F_OPER_TYPE":"", "F_USER_ID": "1023650", "F_NEED_APPLY": "1", "F_APPLY_FILES": [{ "F_TYPE": "1", "F_OBJECT": "CCBX20190428213552", "F_FILES": [{ "F_FILE_NAME": data.name, "F_FILE_PATH": "", "F_FILE_SIZE": data.size, "F_FILE_MD5": "", "F_UPLOAD_ZIP": "", "F_ENCRYPT": "", "F_ENCRYPT_KEY": "" }] }] }
